...
public class ChineseCharacterUtil {
    ...
    public static char firstPinyin(String s)throws ArrayIndexOutOfBoundsException{
        if(s.charAt(0) >= 0x4E00 && s.charAt(0) <= 0x9FA5)
            return convertSingleHanzi2Pinyin(s.charAt(0)).toUpperCase().charAt(0);
        else
            return '*';
    ...
    public static void main(String[] args) {
        try {
            System.out.println(firstPinyin("0"));
        }catch (Exception e){
            e.printStackTrace();
