...
public class SendMail {
    ...
    //properties配置文件地址
    private static final String PROPERTIES_PATH = "sendMail.properties";
    private static Session session;
    private static Properties props = new Properties();
    private static final String HOST = "smtp.qq.com";
    private static int PORT = 25;
//    private static int PORT = 587;成功
    private static final String isAUTH = "true";
    private static final String FROM = "meeting_code@qq.com";

    private static final String USERNAME = "meeting_code@qq.com";
    private static final String PASSWORD = "pdamokariruibacj";
    ...
    public static void main(String[] args) {
        try {
            ...
            sendTextEmail("1261150159@qq.com", "2645763241@qq.com", "主题", "大佬");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static Boolean sendTextEmail(String from, String to, String subject, String content)
        ...
        try {
            ...
            message.setFrom(new InternetAddress(from,"验证码"));
